                    ...
                    <div class="footer-widget fl-wrap">
                        ...
                        <div class="footer-contacts-widget fl-wrap">
                            <p>In ut odio libero, at vulputate urna. Nulla tristique mi a massa convallis cursus. Nulla
                                eu mi magna. Etiam suscipit commodo gravida. </p>
                            <ul class="footer-contacts fl-wrap no-list-style">
                                <li><span><i class="fal fa-envelope"></i> Mail :</span><a href="#" target="_blank">yourmail@domain.com</a>
                                </li>
                                <li><span><i class="fal fa-map-marker"></i> Adress :</span><a href="#" target="_blank">USA
...
<div class="main-register-wrap modal">
    ...
    <div class="main-register-holder tabs-act">
        <div class="main-register fl-wrap  modal_main">
            <div class="main-register_title">Bienvenido a <span><strong>Ram</strong>Publicidad<strong>.</strong></span></div>
                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="form-group row mb-0">
                                    <div class="col-md-12 offset-md-12">
                                        ...
                                        {{-- <a href="{{URL::to('/')}}/social/login/redirect/google" > <button type="button" class="btn" style="background:#343a40;color:#fff;">--}}
                                            {{-- Google Sign In--}}
                                            {{-- </button></a>--}}
...
<script src="{{ asset('template/js/myjs/modals.js') }}"></script>
...
<script>
    $(document).ready(function() {
        let dataString = "id=" + $('#id_customer').val();
        $.ajax({
            type: "GET",
            url: "/show_my_calendar",
            data: dataString,
            dataType: "json",
            success: function(data) {
                ...
                $('#calendar').fullCalendar({
                    ...
                    eventClick: function(calEvent, jsEvent, view) {
                        ...
                        $('#date_event').text(calEvent.title);
